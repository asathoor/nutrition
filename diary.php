...
<form id="getData" action="#" method="get" enctype="multipart/form-data">
	<fieldset>
		...
		<label>Date</label>  <input type="date" name="date" size="30"><br>
		<label>Route</label>  <input type="text" name="route" size="30"><br>
		<label>Km.</label>  <input type="number" name="km" size="30"><br>
		<label>Time</label>  <input type="text" name="time" size="30"><br>
		<label>Notes</label>  <input type="text" name="notes" size="30"><br>
